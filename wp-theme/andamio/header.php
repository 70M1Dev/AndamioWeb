...
<header class="sticky top-0 z-40 bg-ink-900/95 backdrop-blur text-white">
    <nav class="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <a href="<?php echo esc_url(andamio_sitio()); ?>" class="flex items-center gap-2.5" aria-label="Andamio Web, inicio">
        ...
        <div class="hidden md:flex items-center gap-7 text-sm text-white/80">
            <a href="<?php echo esc_url(andamio_sitio('#planes')); ?>" class="hover:text-white">Planes</a>
            <a href="<?php echo esc_url(andamio_sitio('#caso')); ?>" class="hover:text-white">Casos</a>
            <a href="<?php echo esc_url(andamio_sitio('#proceso')); ?>" class="hover:text-white">Cómo trabajamos</a>
            <a href="<?php echo esc_url(andamio_sitio('#faq')); ?>" class="hover:text-white">Preguntas</a>
